 ...
 * </ol>
 */
public class TextureVideoView extends TextureView implements VideoControllerView.MediaPlayerControl {
  ...
  /* OnBufferUpdate listener is set in VideoDetailFragment, Current feed conains video format as radio streaming ("m3u8")
   * progress bar is hide in onBufferingUpdate  to avoid blank screen,if we remove progress bar in onPrepare it show blank screen for a while.
   */
    ...
    public void setCurrentBuffering(int percent) {
        mCurrentBufferPercentage = percent;
    }

    private MediaPlayer.OnBufferingUpdateListener mBufferingUpdateListener;

    public void setOnBufferListener(MediaPlayer.OnBufferingUpdateListener l) {
        mBufferingUpdateListener = l;
    }

    /**
     * Register a callback to be invoked when full screen button has been
     * clicked.
     *
     * @param l The callback that will be run
     */
    public void setFullScreenListener(OrientationListener l) {
     ...
     * TextureVideoView will inform the user of any errors.
     *
     * @param l The callback that will be run
     */
    ...
    public void toggleFullScreen() {
        mOrientationListener.setOrientation((isFullScreen()) ? ActivityInfo.SCREEN_ORIENTATION_SENSOR_PORTRAIT : ActivityInfo.SCREEN_ORIENTATION_SENSOR_LANDSCAPE);
